                                    ...
                                    <div class="tab-pane fade active show" id="account-general">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-outline mb-4">
                                                <input type="date" class="form-control" value="${user.getDob()}" name="birthdate">
                                                <label class="form-label">Birthdate</label>
                                            </div>

                                            <div class="form-outline mb-4">
                                                <input type="tel" class="form-control" value="${user.getPhone()}" name="phone">
                                                <label class="form-label">Phone</label>
                                            </div>

                                            <div class="form-outline mb-4">
                                                <input type="email" class="form-control mb-1" value="${user.getEmail()}" name="email">
                                            ...
                                            <div class="form-outline mb-4">
                                                <textarea class="form-control mb-1" style="resize: none;" rows="5"
                                                          name="address">${user.getAddress()}</textarea>
