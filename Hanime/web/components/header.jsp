...
<header class="web__header">
    <div style="display: flex; align-items: center; height: 44px;">
        ...
        <nav-bar-component style="margin-left: -400px;">
            ...
            <a onclick="openSearch()" id="nav-btn-search-bar">
        ...
        <a href="<%= contextPath %>" title="Trang chủ HAnime" >
...
<div class="web__header__searchbar__popup">
    <form action="Hanime/search" method="get" id="search-bar" autocomplete="off">
        <input type="text" name="q" id="search-bar-popup" onblur="closeSearch()" placeholder="Search">
    </form>
    <button onclick="document.getElementById('search-bar').submit();" style="width: 60px; height: 60px;">
        <svg viewBox="0 0 24 24" focusable="false"
                style="pointer-events: none; display: block; width: 100%; height: 100%;">
            <path style="fill: white;"
                    d="M20.87,20.17l-5.59-5.59C16.35,13.35,17,11.75,17,10c0-3.87-3.13-7-7-7s-7,3.13-7,7s3.13,7,7,7c1.75,0,3.35-0.65,4.58-1.71 l5.59,5.59L20.87,20.17z M10,16c-3.31,0-6-2.69-6-6s2.69-6,6-6s6,2.69,6,6S13.31,16,10,16z">
